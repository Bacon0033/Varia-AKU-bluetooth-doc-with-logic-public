...
This is everything I discovered about the Acaia scales' Bluetooth protocol through manual packet sniffing, along with some algorithms I use to calculate my data. There's no official documentation from Acaia, so I had to reverse-engineer all of this. Hopefully, this saves you the hours I spent figuring it out!
